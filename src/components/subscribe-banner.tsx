...
export function SubscribeBanner({ brand }: { brand: Brand }) {
  ...
  if (isCanceled) {
    return (
      <div className="bg-red-50/70 backdrop-blur-lg border border-red-200/50 rounded-2xl px-5 py-4 flex items-center justify-between gap-4">
        <div>
  ...
  if (isTrialing) {
    ...
    return (
      <div className="bg-amber-50/70 backdrop-blur-lg border border-amber-200/50 rounded-2xl px-5 py-4 flex items-center justify-between gap-4">
        <div>
