  ...
  return (
    <div className="max-w-5xl" role="alert">
      <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-2xl p-8 text-center space-y-4 shadow-lg shadow-gray-200/20">
        <h2 className="text-lg font-semibold text-gray-900">Failed to load insights</h2>
        <p className="text-sm text-gray-500">There was a problem loading auction insights data. This is usually temporary.</p>
