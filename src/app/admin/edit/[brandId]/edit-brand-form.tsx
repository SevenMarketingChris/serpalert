...
export function EditBrandForm({ brand }: { brand: Brand }) {
  ...
  return (
    <Card className="max-w-lg card-neon-hover">
      <CardHeader>
        <CardTitle className="text-base font-semibold">Edit Brand</CardTitle>
      </CardHeader>
      <CardContent>
        <form action={formAction} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="keywords">Keywords <span className="text-muted-foreground font-normal">(one per line or comma-separated)</span></Label>
            <textarea
              id="keywords"
              name="keywords"
              rows={4}
          ...
          <div className="space-y-1.5">
            ...
            <Input id="domain" name="domain" defaultValue={brand.domain ?? ''} placeholder="acmecorp.co.uk" />
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  min="0"
                  step="0.01"
                  defaultValue={brand.monthlyBrandSpend ?? ''}
                  placeholder="0.00"
                  className="pl-6"
                />
              </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input id="customerId" name="customerId" defaultValue={brand.googleAdsCustomerId ?? ''} placeholder="123-456-7890" />
          </div>
