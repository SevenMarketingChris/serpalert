...
Processing typically takes two to three weeks. If the complaint is upheld, Google adds your trademark to its restricted list, preventing other advertisers from including it in their ad copy within the specified markets. Our [Google Ads trademark complaint template](/blog/google-ads-trademark-complaint-template) walks you through each field to help you submit a strong complaint the first time.
...
Consider escalation when the competitor has ignored direct communication and trademark complaints, is using your trademark in their ad copy, the financial impact is significant, or multiple competitors are engaging in the same behaviour. Use the [brand bidding calculator](/calculator) to quantify the revenue impact before deciding whether the cost of legal action is justified. Your case is strongest when the competitor is using your trademark in their ad text or making misleading claims. Keyword-only targeting is harder to challenge legally, though not impossible in all jurisdictions.
