...
This is why "stopping" brand bidding is the wrong framing. The real question is how to respond to it effectively.
...
Other common defensive tactics include strengthening organic presence (site links, knowledge panels, review extensions) and sending cease-and-desist letters to competitors. The organic work is genuinely valuable regardless, but letters carry no legal weight in the UK when it comes to keyword bidding — the courts have consistently held that bidding on a competitor's brand name is not trademark infringement.
