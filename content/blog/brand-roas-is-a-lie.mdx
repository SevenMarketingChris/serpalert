...
This is not a theoretical problem. Studies consistently show that 60-90% of brand ad clicks would have occurred as organic clicks if the ad were not present. When you strip out these cannibalised clicks, the true ROAS of most brand campaigns drops dramatically.
...
**Budget allocation.** If brand campaigns show 10x ROAS and non-brand campaigns show 3x ROAS, the "rational" decision is to allocate more budget to brand. But if the true incremental ROAS is 2x for brand and 2.5x for non-brand (with 80% incrementality), you should be doing the opposite.
...
**Run the numbers on your own account.** Use our [brand bidding calculator](/calculator) to estimate the gap between your reported and incremental brand ROAS. Even a rough estimate reveals the scale of the problem.
