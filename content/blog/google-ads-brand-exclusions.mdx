...
Getting brand exclusions right is one half of the equation. The other half is deciding [how to split your budget between branded and non-branded keywords](/blog/branded-vs-non-branded-keywords-budget) so your account structure works as a whole.
